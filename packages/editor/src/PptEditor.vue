...
const shapePaint = computed<ShapePaintToolbarProps>(() => {
  ...
  return {
    ...
    fillIsPattern: node.resolvedFillPattern !== undefined,
    ...(node.resolvedFillPattern ? { fillPatternPreset: node.resolvedFillPattern.preset } : {}),
    ...(node.resolvedFillPattern ? { fillPatternForeground: `#${node.resolvedFillPattern.foreground.rgb.toUpperCase()}` } : {}),
