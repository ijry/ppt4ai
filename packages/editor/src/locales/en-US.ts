const enUS = {
  ...
  toolbar: {
    ...
    shapePaint: {
      ...
      gradient: 'Gradient',
      fillGradientStart: 'Fill gradient start',
      fillGradientEnd: 'Fill gradient end',
      fillGradientAngle: 'Fill gradient angle',
      fillPatternPreset: 'Fill pattern preset',
      fillPatternForeground: 'Fill pattern foreground',
      fillPatternBackground: 'Fill pattern background',
      strokeGradientStart: 'Outline gradient start',
      strokeGradientEnd: 'Outline gradient end',
      strokeGradientAngle: 'Outline gradient angle',
      strokePatternPreset: 'Outline pattern preset',
      strokePatternForeground: 'Outline pattern foreground',
      strokePatternBackground: 'Outline pattern background',
      inherited: 'Inherited',
      clear: 'Clear',
