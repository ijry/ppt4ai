...
- [ ] **Step 1: Add the pinned ProseMirror dependencies and failing conversion tests**
...
- [ ] **Step 2: Run the conversion tests and verify the expected RED state**
...
- [ ] **Step 3: Implement the schema with JSON-safe attrs**
...
- [ ] **Step 4: Implement validated, cloned conversion functions**
...
- [ ] **Step 5: Export the conversion API and run focused GREEN checks**
...
- [ ] **Step 1: Write failing transaction and composition tests**
...
- [ ] **Step 2: Run the state tests and verify the expected RED state**
...
- [ ] **Step 3: Implement composition plugin state**
...
- [ ] **Step 4: Implement editor state creation and pure transaction helpers**
...
- [ ] **Step 5: Implement cloned snapshots and run focused GREEN checks**
...
- [ ] **Step 1: Write failing controller tests with a real host and bridge spy**
...
- [ ] **Step 2: Run controller tests and verify the expected RED state**
...
- [ ] **Step 3: Implement the controller without duplicating document state**
...
- [ ] **Step 4: Export the controller and run editor GREEN checks**
...
- [ ] **Step 2: Update the plan and progress handoff**
...
- [ ] **Step 4: Create the only implementation commit for this slice**
