...
- [x] **Step 2: Run the focused model tests**
...
- [x] **Step 3: Implement the JSON-safe contracts**
...
- [x] **Step 4: Implement validation and run it**
...
- [x] **Step 1: Add dependency and failing normalization tests**
...
- [x] **Step 2: Add failing measurement tests**
...
- [x] **Step 5: Implement fixed EMU measurement**
...
- [x] **Step 6: Run model and text checks**
...
- [x] **Step 2: Write failing geometry tests**
...
- [x] **Step 5: Implement deterministic line geometry**
...
- [x] **Step 6: Run focused layout checks**
...
- [x] **Step 1: Write failing Autofit tests**
...
- [x] **Step 2: Verify Autofit tests fail**
...
- [x] **Step 3: Implement Autofit orchestration**
...
- [x] **Step 4: Verify scale and JSON safety**
...
- [x] **Step 1: Add dependency and failing SceneGraph tests**
...
- [x] **Step 3: Integrate headless layout**
...
- [x] **Step 4: Run render and boundary checks**
...
- [x] **Step 2: Inspect and document the completed stage**
...
- [x] **Step 3: Create the only Stage 4 commit**
