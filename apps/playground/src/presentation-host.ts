...
export interface PlaygroundPresentationHost {
  ...
  addMaster(sourceMasterId: string): PlaygroundPresentationSnapshot
...
export function createPlaygroundPresentationHost(): PlaygroundPresentationHost {
  ...
  return {
    ...
    toggleSelectedElementFlip(elementId, axis) {
      return forward((host) => host.toggleSelectedElementFlip(elementId, axis))
    },
    flipSelection(axis) {
      return forward((host) => host.flipSelection(axis))
    },
    ...
    setSlideLayout(layoutId) {
      return forward((host) => host.setSlideLayout(layoutId))
    },
    ...
    addMaster(sourceMasterId) {
      return forward((host) => host.addMaster(sourceMasterId))
    },
